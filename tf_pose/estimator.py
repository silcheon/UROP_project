...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                centers[i] = center
                cv2.circle(npimg, center, 3, common.CocoColors[i], thickness=9, lineType=8, shift=0)
            ...
            for pair_order, pair in enumerate(common.CocoPairsRender):
                ...
                cv2.line(npimg, centers[pair[0]], centers[pair[1]], common.CocoColors[pair_order], 7)
    ...
    def inference(self, npimg, resize_to_default=True, upsample_size=1.0):
        ...
        # print(humans.pairs)
        # for point in humans : 
        #     print(f"{point.body_parts.part_idx}")# :  ({point.x}, {point.y})")
        return humans
